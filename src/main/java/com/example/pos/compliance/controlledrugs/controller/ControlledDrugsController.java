package com.example.pos.compliance.controlledrugs.controller;

import com.example.pos.common.dto.ApiResponse;
import com.example.pos.compliance.controlledrugs.dto.ControlledDrugsRequestDto;
import com.example.pos.compliance.controlledrugs.dto.ControlledDrugsResponseDto;
import com.example.pos.compliance.controlledrugs.model.ControlledDrugs;
import com.example.pos.compliance.controlledrugs.service.ControlledDrugsService;
...
@RestController
@RequestMapping("/api/controlled-drugs")
public class ControlledDrugsController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<ControlledDrugsResponseDto>> getById(@PathVariable Long id) {
