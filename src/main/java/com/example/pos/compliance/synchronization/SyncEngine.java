...
public class SyncEngine {
    ...
    private final EtimsSyncStateRepository stateRepo;

    public SyncEngine(List<EtimsSynchronizer> synchronizers, EtimsSyncStateRepository stateRepo) {
    ...
    private void updateState(String syncType, EtimsSynchronizer.SyncResult result) {
        EtimsSyncState state = stateRepo.findBySyncTypeAndTenantId(syncType, null)
                .orElseGet(() -> EtimsSyncState.builder().syncType(syncType).build());
